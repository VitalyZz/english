...
class DictionaryController
{
    ...
    public function getDictionaryById(): array
    {
        $data = json_decode(file_get_contents("php://input"), true);
        ...
        $sql = "SELECT id_dictionary, title_dictionary as title FROM dictionaries WHERE id_user = :id_user AND id_dictionary = :id_dictionary";
    ...
    public function create(): array
    {
        ...
        return [
            'id_dictionary' => $this->connection->lastInsertId(),
            'title' => $title
        ];
    }
